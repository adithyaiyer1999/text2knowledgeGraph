...
def ask_chatgpt(prompt, model="gpt-3.5-turbo", max_tokens=100):
    ...
    try:
        ...
        print(str(e))
        return {"error" : "Sorry! We have encountered the following error: "+str(e)+" \nIf you are someone who finds this useful, reach out to adithyaiyer1999@gmail.com, srushtipawar12@gmail.com or amjkaiser@gmail.com, and we can provide some backup."}
